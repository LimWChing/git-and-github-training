For the Practical 1 Assignment, you will open up your command line and complete the following:
...
Once you have completed these steps, take a screenshot of your command line, with the steps above, and upload your screenshot to a new `Issue` titled `Practical 1`.
